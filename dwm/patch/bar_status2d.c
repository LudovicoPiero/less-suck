...
int width_status2d(Bar *bar, BarArg *a) {
  int width;
...
int width_status2d_es(Bar *bar, BarArg *a) {
  int width;
...
int draw_status2d(Bar *bar, BarArg *a) {
#if BAR_EXTRASTATUS_PATCH || BAR_STATUSCMD_PATCH
...
#if BAR_EXTRASTATUS_PATCH
int draw_status2d_es(Bar *bar, BarArg *a) {
#if BAR_STATUSCMD_PATCH
...
#if !BAR_STATUSCMD_PATCH
int click_status2d(Bar *bar, Arg *arg, BarArg *a) { return ClkStatusText; }
#endif // BAR_STATUSCMD_PATCH

int drawstatusbar(BarArg *a, char *stext) {
  int i, w, len;
  int x = a->x;
  int y = a->y;
  short isCode = 0;
