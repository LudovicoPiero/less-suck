int width_statuscolors(Bar *bar, BarArg *a) {
...
int width_statuscolors_es(Bar *bar, BarArg *a) {
#if BAR_STATUSCMD_PATCH
...
int draw_statuscolors(Bar *bar, BarArg *a) {
#if BAR_STATUSCMD_PATCH
...
#if BAR_EXTRASTATUS_PATCH
int draw_statuscolors_es(Bar *bar, BarArg *a) {
#if BAR_STATUSCMD_PATCH
...
#if !BAR_STATUSCMD_PATCH
int click_statuscolors(Bar *bar, Arg *arg, BarArg *a) { return ClkStatusText; }
#endif // BAR_STATUSCMD_PATCH

int textw_wosc(char *s) {
  char *ts = s;
  char *tp = s;
  int sw = 0;
  char ctmp;
...
int draw_wosc(Bar *bar, BarArg *a, char *s) {
  char *ts = s;
  char *tp = s;
  int tx = 0;
  char ctmp;
