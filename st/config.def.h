 ...
 */
static char *font = "Iosevka q:pixelsize=12:antialias=true:autohint=true";
#if FONT2_PATCH
/* Spare fonts */
static char *font2[] = {
...
static const char *colorname[] = {
    /* 8 normal colors */
    "#161616", "#3ddbd9", "#33b1ff", "#ee5396", "#42be65", "#be95ff", "#ff7eb6",
    "#f2f4f8",

    /* 8 bright colors */
    "#525252", "#78a9ff", "#262626", "#393939", "#dde1e6", "#ffffff", "#82cfff",
    "#08bdba",
